...
// EXEC LNKEDT
// ASSGN SYS010,X'192'
// DLBL OUTFILE,'BG.IVP.WORKFILE',0,SD
// EXTENT SYS010,WRK14A,1,0,1400,300
// EXEC 
// DLBL   UIN,'BG.IVP.WORKFILE',,SD
// EXTENT SYS004,WRK14A
// ASSGN SYS004,X'192'       INPUT FROM FILE CREATED ABOVE
...
// END
/*
// DLBL SORTOUT,'BG.IVP.WORKFILE.SORTED',0,SD
// EXTENT SYS001,WRK14A,1,0,2600,300
// DLBL SORTIN1,'BG.IVP.WORKFILE',,SD
...
// EXEC SORT
 ...
 END
/*
// DLBL   UIN,'BG.IVP.WORKFILE.SORTED',,SD
// EXTENT SYS004,WRK14A
// ASSGN SYS004,X'192'       INPUT FROM FILE CREATED ABOVE
// ASSGN SYS005,X'00E'       OUTPUT TO PRINTER
// UPSI 00000000             STANDARD LABELS ON INPUT
