//G08STG1  JOB  1,'VS1 6.7 Stage 1',                                   +
//             CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1),COND=(0,NE)
//*********************************************************************
//*                                                                 ***
//*    Job:      G08STG1                                            ***
//*    Product:  VS1 6.7.                                           ***
//*    Purpose:  Run SYSGEN stage 1 for VS1 6.7.                    ***
//*    Run on:   Generating system                                  ***
//*    Update:   2021/06/27 add UNITNAME for SYSSQ with the         ***
//*                         same devices as SYSDA                   ***
//*                                                                 ***
//*    Note:     Include the DD statement for SYS1.SMPMTS           ***
//*              or not as the first statement in the SYSLIB        ***
//*              concatenation depending on whether you have        ***
//*              SMP-modified stage 1 sysgen macros.                ***
//*                                                                 ***
//*********************************************************************
//*
//*
...
//* VS1 6.7 DLIBs
//*SYSLIB   DD  DISP=SHR,DSN=SYS1.SMPMTS,DCB=BLKSIZE=19040
//SYSLIB   DD  DISP=SHR,DSN=SYS1.AGENLIB,VOL=SER=FDLB67,UNIT=SYSDA
//         DD  DISP=SHR,DSN=SYS1.AMODGEN,VOL=SER=FDLB67,UNIT=SYSDA
...
***********************************************************************
     ...
     JES       ALCUNIT=28138,              Allocation units            +
               ...
               JOBQVOL=FGEN67,             Job queue volume            +
               ...
               SPOLVOL=FGEN67,             Volume containing spool     +
...
***********************************************************************
     ...
     SVCTABLE                                                          +
               ...
               SVC-251-D1-S0,              HASP                        +
               SVC-249-E3-S2,              PKEY                        +
               SVC-248-E4-S6,              Available                   +
               SVC-242-D4-S6,              Available                   +
               SVC-234-D3-S6,              Available                   +
               SVC-228-E4-S6,              Available                   +
               SVC-227-E4-S6,              Available                   +
               SVC-231-E3-S6,              Available                   +
               SVC-217-E2-S6,              Available                   +
               SVC-216-D2-S6,              Available                   +
               SVC-214-D1-S0,              Available                   +
               SVC-213-E1-S0               Available
     EJECT ,
***********************************************************************
*                                                                     *
*        Add dummy type 1 and 2 SVCs to the nucleus.                  *
*                                                                     *
***********************************************************************
     SPACE 1
     RESMODS   PDS=SYS1.AUSERSVC,                                      +
               MEMBERS=(IGC213,                                        +
               IGC214,                                                 +
               IGC216,                                                 +
               IGC217,                                                 +
...
***********************************************************************
*                                                                     *
*        Add dummy type 3 and 4 SVCs to SYS1.SVCLIB.                  *
*                                                                     *
***********************************************************************
     SPACE 1
     SVCLIB    PDS=SYS1.AUSERSVC,                                      +
               MEMBERS=(IGC0022G,                                      +
               IGC0022H,                                               +
               IGC0023A,                                               +
               IGC0023D,                                               +
...
***********************************************************************
     SPACE 1
     SECONSLE  CONSOLE=010,ALTCONS=01F,ROUTCDE=ALL,VALDCMD=(1,2,3)
     EJECT ,
***********************************************************************
*                                                                     *
*        Channels.                                                    *
...
***********************************************************************
     SPACE 1
     GENERATE                                                          +
               GENTYPE=ALL,                Full sysgen                 +
               INDEX=SYS1,                 System data set qualifier   +
               JCLASS=A,                   Stage 2 job class           +
               OBJPDS1=SYS1.OBJPDS1,       For stage 2 assembly output +
               OBJPDS2=SYS1.OBJPDS2,       For stage 2 assembly output +
               OBJPDS3=SYS1.OBJPDS3,       For stage 2 assembly output +
               OCLASS=A,                   Stage 2 SYSOUT class        +
               RESVOL=(FGEN67,3350)        New sysres volume
     END   ,
/*
//*
