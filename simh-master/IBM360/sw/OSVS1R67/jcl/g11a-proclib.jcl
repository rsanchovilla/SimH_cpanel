//G11PROCL JOB 1,'Update PROCLIB',                                     +
//             CLASS=A,MSGCLASS=A,MSGLEVEL=(1,1)
//*********************************************************************
//*                                                                 ***
//*    Job:      G11PROCL                                           ***
//*    Product:  VS1 6.7.                                           ***
//*    Purpose:  Update SYS1.PROCLIB on new VS1 6.7 sysres volume.  ***
...
//SYSUT2    DD DISP=SHR,DSN=SYS1.PROCLIB,UNIT=3350,VOL=SER=FGEN67
//SYSIN     DD DATA
./ ADD NAME=DIP
//DIP      PROC
//*********************************************************************
...
//*********************************************************************
//*
//IEFPROC   EXEC   PGM=IEFIIC,PARM='SWA=3072'
./ ADD NAME=TAPEMAP
//********************************************************************* 00000100
//*                                                                 *** 00000200
