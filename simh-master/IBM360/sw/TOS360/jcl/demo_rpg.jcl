...
// EXEC RPG
     ...
     F* TYPICAL BUSINESS APPLICATION
     F* DEMONSTRATES TABLES AND CONTROL BREAK
     ...
     C   01      CURSAL    MULT COMRAT    COMPAY  62H
     C   01      YREMP     LOKUPTABARG    TABFUN  52     03
     C   01 03   TABFUN    ADD  COMPAY    GRSPAY  62
     C*                    F I C A   T A X
     C   01      YTDPAY    ADD  GRSPAY    YTDPA   72
     C   01      YTDPA     COMP 10800.               09
     C   01N09   GRSPAY    MULT .0585     FICA    42H      ALL PAY TAXED
     ...
     C   01      FICA      ADD  DFICA     DFICA   52
     C   01      FIT       ADD  DFIT      DFIT    62
     C   01      SIT       ADD  DSIT      DSIT    52
     C   01      DEDUCT    ADD  DDDUCT    DDDUCT  62
     C   01      NETPAY    ADD  DNTPAY    DNTPAY  72
     CL1         DGSPAY    ADD  CGSPAY    CGSPAY  72
     CL1         DFICA     ADD  CFICA     CFICA   52
     CL1         DFIT      ADD  CFIT      CFIT    62
     CL1         DSIT      ADD  CSIT      CSIT    52
     CL1         DDDUCT    ADD  CDDUCT    CDDUCT  62
